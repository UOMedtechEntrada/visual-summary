...
export default class SlideInFilter extends Component {
    ...
    createSelect(label, optionArray = [], defaultValue = []) {
        ...
        data.map(record => {
            ...
            let context_values = record.situationContextCollection;
        ...
        if (modifiedOptionArray.length > 0) {
            ...
            return (
                <div className='demographic-box inner-filter-box family-medicine' key={label}>
                    <label className='filter-label'>{label}</label>
                    <div className='select-container-filter family-medicine'>
                        <Select
                            isClearable={true}
                            isMulti={true}
                            name={label}
    ...
    render() {
        ...
        return (
            <div className='filter-box' style={{ 'width': (width) - 25 }}>
