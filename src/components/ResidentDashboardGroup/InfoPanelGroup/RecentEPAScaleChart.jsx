...
class RecentEPAScaleChart extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h4 className='scale-label m-t-0 m-b-0'>{t("Scale")} : {this.props.scaleTitle}</h4>
...
export default withTranslation()(connect(null, mapDispatchToProps)(RecentEPAScaleChart));
