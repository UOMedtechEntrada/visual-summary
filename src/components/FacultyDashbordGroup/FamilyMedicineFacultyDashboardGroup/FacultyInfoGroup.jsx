...
export default (props) => {
    ...
    return <div className='text-center'>
        <div className='print-info' style={{ 'display': 'inline-block', 'width': '1120px' }}>
            <FacultyStatCardSet
                tooltipRef={infoTooltipReference.facultyDevlopment.FMacquisitionMetricsForAllFaculty}
            ...
            {(currentFaculty !== 'ALL' && currentFaculty !== '') && <FacultyStatCardSet
                tooltipRef={infoTooltipReference.facultyDevlopment.FMacquisitionMetricsForSingleFaculty}
