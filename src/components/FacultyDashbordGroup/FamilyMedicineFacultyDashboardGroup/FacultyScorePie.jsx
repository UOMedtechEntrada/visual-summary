...
const fourPointColorScale = ["#e15759", "#f28e2c", "#4e79a7", "#59a14f"];
...
const Pie = props => {
    ...
    const colourScale = fourPointColorScale;
    ...
    return (
        <div  className={'faculty-pie-wrapper big-box ' + (showNA ? 'p-a' : '')}>
                <span className="pie-title">SUPERVISORY LEVEL</span>
            {showNA ?
