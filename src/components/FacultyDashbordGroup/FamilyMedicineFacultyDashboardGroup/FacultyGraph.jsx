...
export default class FacultyGraph extends Component {
    ...
    render() {
        ...
        // epa score scale doesnt vary based on max values but its always between 0 and 4
        if (trackType == 'entrustment_score') {
            scaleY = d3.scaleLinear().range([height - margin, margin]).domain([0, 4]);
        }
        ...
        // for entrustment score we have 5 lines and special axis texts
        if (trackType == 'entrustment_score') {
            axisTickLines = _.times(5, (index) => {
